...
def graph_plot(original_edges, partitioned_edges, num_nodes_original, subsets):
    ...
    nx.draw(G_original, pos_original, with_labels=True, node_size=50, node_color='skyblue', font_weight='bold',
            font_color='black')
    ...
    for i, subset in enumerate(subsets):
        ...
        nx.draw_networkx_nodes(G_partitioned, pos_partitioned, nodelist=nodes, node_color=[color], label=f"Subset {i + 1}")
